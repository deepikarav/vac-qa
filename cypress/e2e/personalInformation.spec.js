...
describe('Test Suite', function()
{
    ...
    it('Personal Information Test', function()
    {
        ...
        personalInformationPage.getDobYearTBox().first().type(this.data.year).should('have.value', this.data.year)
        personalInformationPage.getDobMonthTBox().first().type(this.data.month).should('have.value', this.data.month)
        personalInformationPage.getDobDayTBox().first().type(this.data.day).should('have.value', this.data.day)
        ...
        personalInformationPage.getCitizenshipCountryTBox().type(this.data.citizenshipCountry).should('have.value', this.data.citizenshipCountry)
        ...
        personalInformationPage.getPastCountryOfResidence().click()
