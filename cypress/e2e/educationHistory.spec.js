...
describe("Test Suite", function () {
  ...
  it("Education History form fill test", function () {
    ...
    if (this.data.educationHistory === "Yes") {
      educationHistoryPage.getAddEducationButton().click({ force: true });
      cy.wait(2000);
      educationHistoryPage
      ...
      if (this.data.educationOngoing) {
        educationHistoryPage.getOngoingCheckbox().click({ force: true });
      } else {
        educationHistoryPage
          .getToYearDropDown()
          .clear()
      ...
      if (this.data.educationCountry === "Canada") {
        educationHistoryPage
          ...
          .clear()
          .type(this.data.educationProvince, { force: true });
        //educationHistoryPage.getEducationProvince(this.data.educationProvince);
      } else if (this.data.educationCountry === "United States of America") {
        educationHistoryPage
          .getEducationStateDropdown()
          .clear()
          .type(this.data.educationState, { force: true });
      }
